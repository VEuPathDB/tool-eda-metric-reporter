...
node(params.NODE) {
  ...
  Python("bin/run.py ${params.ENV} ${params.EDA_URL} ${params.PROM_URL} ${params.CALENDAR_MONTH} ${params.DB_LDAP_CN} ${params.LDAP_HOST} ${params.LDAP_QUERY} ${params.DB_USER} ${params.SECRETS_FILE} ${params.PROJECT_ID} ${params.QA_SECRETS_FILE}")
}
